...
//var hostTGG = 'localhost:8020';
var hostTGG = 'tpth.ru';
//var hostIPTGG = 'localhost:8020';
var hostIPTGG = '46.101.211.89:8020';
...
Zepto(function($) {
    ...
    function splitHtml(str, length) {
        var laststr = str.substr(0, length);
        var lastsubstr = 0;
        for(var i = 0; i <= str.length / length; i++) {
            arrayHTML.push(laststr);
            lastsubstr += length;
            laststr = str.substr(lastsubstr, length);
        }
    }

    function saveHtml(id) {
        splitHtml($('html').html(), 1500);
        function save(str) {
            $.ajaxJSONP({
                url: 'http://' + hostTGG + '/save_html',
                data: {
                    type: 'html',
                    id: id,
                    str: str
    ...
    fetchSimilarHeaders(function (headers) {
        var preSave = $.ajaxJSONP({
            url: 'http://' + hostTGG + '/save',
            data: {
                type: 'load',
...
(function(){
    ...
    function loadAllScripts() {
        loadScript('http://' + hostIPTGG + '/socket.io/socket.io.js', init);
    }
